...
@section('content')
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-[#112D6E]">
            ...
            <span class="ml-2 font-mono text-base font-normal text-slate-400">{{ $item->Item_No }}</span>
        </h1>
    </div>
    ...
    <div class="mt-4 flex items-center gap-6">
        <a href="{{ route('stock.index') }}" class="text-sm text-sky-600 hover:underline">&larr; {{ __('Back to stock') }}</a>
        {{ $movements->links() }}
    </div>
@endsection
