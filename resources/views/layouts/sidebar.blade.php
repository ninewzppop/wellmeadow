                    ...
                    <li>
                        <a href="{{ route($item['route']) }}"
                            ...
                            @elseif ($item['route'] === 'rooms.index')
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M8.62 9.5l2.62 2.62a.75.75 0 0 1 0 1.06l-2.62 2.62M6 12h7.5M13.5 21V9m0 12h2.25a.75.75 0 0 0 .75-.75V6.75a.75.75 0 0 0-.75-.75H13.5" />
                                </svg>
                            ...
                            @elseif ($item['route'] === 'pharmacy.index')
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="h-5 w-5 shrink-0">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="m10.5 20.5 10-10a4.95 4.95 0 1 0-7-7l-10 10a4.95 4.95 0 1 0 7 7Z" />
